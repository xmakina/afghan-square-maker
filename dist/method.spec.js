...
describe("with a method", () => {
    ...
    describe("with alternating repeated instructions", () => {
        ...
        it("explains the repetition", () => {
            expect(result[1]).toEqual("Row 1 and All Odd Numbered Rows: some repeated value");
    ...
    describe("with alternating even repeated instructions", () => {
        ...
        it("explains the repetition", () => {
            expect(result[2]).toEqual("Row 2 and All Even Numbered Rows: some repeated value");
